...
export default function Onboarding3() {
  ...
  const goNext = () => router.replace("/home");
  ...
  return (
    <Screen>
        ...
        <View style={styles.center}>
          ...
          <View style={styles.categoryPill}>
            <AppText variant="label" style={styles.categoryText}>
              {t("onboarding3.categoryPlayers")}
            </AppText>
          </View>

          <View style={styles.cards}>
            <PlayerRow index="1" name={t("onboarding.player1")} word={t("onboarding3.wordSame") } />
            <PlayerRow index="2" name={t("onboarding.player2")} word={t("onboarding3.wordSame") } />
            <PlayerRow
              index="3"
              name={t("onboarding.player3")}
              word={t("onboarding3.wordSimilar")}
              danger
      ...
      <BottomBar label={t("onboarding3.startGame")} onPress={goNext} />
    </Screen>
  );
}
    ...
    <View style={[styles.card, danger ? styles.cardDanger : styles.cardNormal]}>
      <View style={styles.cardRow}>
        ...
        <View style={styles.textWrap}>
          ...
          {/* Same font size, no truncation: will shrink to fit */}
          <AppText
            variant="title"
            style={styles.word}
            numberOfLines={1}
...
const styles = StyleSheet.create({
  ...
  dotActive: { width: 26, backgroundColor: "#00e06a" },
